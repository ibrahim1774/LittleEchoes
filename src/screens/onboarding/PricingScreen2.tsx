...
export function PricingScreen2() {
  ...
  async function handleSubscribe() {
    ...
    setError('');
    try {
      const res = await fetch('/api/create-checkout-session-2', {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen bg-echo-cream dark:bg-echo-dark-bg flex flex-col px-6 pt-6 pb-6 overflow-y-auto">
      ...
      <div className="space-y-2 mb-4">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="font-inter text-xs text-echo-gray mt-0.5">$29.99 / year — just $2.50/month</p>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-nunito font-extrabold text-lg text-echo-coral">$29.99</span>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="font-nunito font-extrabold text-lg text-echo-charcoal dark:text-white">$4.99</span>
              <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
      ...
      >
        {loading ? 'Redirecting to checkout...' : `Start with ${selectedPlan === 'yearly' ? 'Yearly — $29.99' : 'Monthly — $4.99/mo'}`}
      </button>
