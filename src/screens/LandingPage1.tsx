  ...
  return (
    <div className="min-h-screen bg-echo-cream font-nunito overflow-y-auto relative">
      ...
      <nav className={`sticky top-0 z-50 flex items-center justify-between px-5 h-14 transition-all ${scrolled ? 'backdrop-blur-md shadow-sm bg-echo-cream/80' : 'bg-echo-cream'}`}>
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => navigate('/signin')} className="font-nunito text-sm font-semibold text-echo-charcoal border-2 border-echo-charcoal/20 px-4 py-1.5 rounded-full active:scale-95 transition-transform">
            Sign In
          </button>
          <button onClick={() => navigate('/signup')} className="font-nunito text-sm font-extrabold text-white bg-echo-coral px-4 py-1.5 rounded-full active:scale-95 transition-transform">
            Start Free Trial
          </button>
        </div>
      </nav>
      ...
      <section ref={heroRef} className="px-5 pt-8 pb-6 text-center">
        ...
        <p className="font-inter text-xs text-echo-gray mb-8">3-day free trial · Cancel anytime</p>
      ...
      <section ref={finalRef} className="px-5 pt-16 pb-12 text-center">
        ...
        <button onClick={() => navigate('/signup')} className="w-full py-4 rounded-full bg-echo-coral text-white font-extrabold text-base shadow-coral active:scale-95 transition-transform mt-6 mb-4">
          Start Free Trial
        </button>
      ...
      >
        <div className="bg-white px-5 pt-3 pb-6 max-w-[480px] mx-auto" style={{ paddingBottom: 'max(24px, env(safe-area-inset-bottom, 24px))' }}>
          <button onClick={() => navigate('/signup')} className="w-full py-3.5 rounded-full bg-echo-coral text-white font-extrabold text-base active:scale-95 transition-transform">
            Start Free Trial
          </button>
        </div>
      </div>
