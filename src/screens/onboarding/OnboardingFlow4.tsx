...
export function OnboardingFlow4() {
  ...
  async function handleSubscribe() {
    ...
    setError('');
    try {
      const res = await fetch('/api/create-checkout-session-4', {
        method: 'POST',
        ...
        {screen === 7 && (
          <div className="flex flex-col w-full gap-4 pt-2 flex-1">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="font-inter text-xs text-echo-gray mt-0.5">$2.50/mo — billed $30/year · 3-day free trial</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-nunito font-extrabold text-lg text-echo-coral">$30</span>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-nunito font-extrabold text-lg text-echo-charcoal dark:text-white">$5</span>
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
            ...
            <div className="mt-auto space-y-3 pt-2">
              ...
              >
                {loading ? 'Redirecting to checkout...' : selectedPlan === 'yearly' ? 'Start My 3-Day Free Trial' : 'Subscribe — $5/mo'}
              </button>
